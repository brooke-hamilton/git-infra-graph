...
- [x] T001 Initialize Go module with `go mod init github.com/brooke-hamilton/git-infra-graph` and add go-git dependency (`github.com/go-git/go-git/v5`) in go.mod
- [x] T002 Create project directory structure per plan.md: `src/cmd/grif/`, `src/graph/`, `src/graph/internal/gitops/`, `testdata/`
